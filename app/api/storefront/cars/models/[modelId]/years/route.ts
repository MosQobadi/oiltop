...
import { getActiveCarModelById, getYearOptionsForModel } from "@/lib/services/fitment";
...
export async function GET(_request: NextRequest, { params }: RouteContext) {
  ...
  const carModel = parsed.success ? await getActiveCarModelById(parsed.data) : null;
  if (!carModel) {
